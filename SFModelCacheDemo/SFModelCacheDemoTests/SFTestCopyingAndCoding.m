...
@interface SFTestModelHashModel : NSObject <NSCopying, NSCoding>
...
@implementation SFTestModelHashModel
...
@interface SFTestEqualAndHash : XCTestCase

@end

@implementation SFTestEqualAndHash

- (void)testHash {
    SFTestModelHashModel *model1 = [SFTestModelHashModel new];
    SFTestModelHashModel *model2 = [SFTestModelHashModel new];
...
- (void)testCopying {
    SFTestModelHashModel *model1 = [SFTestModelHashModel new];
    SFTestModelHashModel *model2 = nil;
...
- (void)testCoding {
    ...
    data = [NSKeyedArchiver archivedDataWithRootObject:model1 requiringSecureCoding:NO error:nil];
