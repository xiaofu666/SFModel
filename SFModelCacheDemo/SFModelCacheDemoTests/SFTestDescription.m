...
@interface SFTestDescriptionModel : NSObject
...
@implementation SFTestDescriptionModel
- (NSString *)description {
    return [self sf_modelDescription];
}
@end
...
@interface SFTestDescription : XCTestCase

@end

@implementation SFTestDescription

- (void)testDescription {
    SFTestDescriptionModel *model = [SFTestDescriptionModel new];
    model.string = @"test";
    model.intValue = 100;
    ...
    for (int i = 0; i < 2; i++) {
        SFTestDescriptionModel *sub = [SFTestDescriptionModel new];
        sub.intValue = i;
