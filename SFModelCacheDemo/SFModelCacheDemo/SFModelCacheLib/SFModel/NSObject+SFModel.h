 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `SFModel` protocol for custom methods.
 ...
 @code
     ...
     int main() {
         ...
         SFBook *book = [SFBook sf_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book sf_modelToJSONString];
 ...
 @code
     @interface SFShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation SFShadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self sf_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self sf_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self sf_modelCopy]; }
     - (NSUInteger)hash { return [self sf_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self sf_modelIsEqual:object]; }
     @end
 @endcode
 ...
 */
+ (nullable instancetype)sf_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)sf_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (nullable id)sf_modelToJSONObject;
 ...
 */
- (nullable NSData *)sf_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)sf_modelToJSONString;
 ...
 */
+ (nullable NSArray *)sf_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (SFModel)
 ...
 */
+ (nullable NSDictionary *)sf_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<SFModel>' to your class header.
 */
@protocol SFModel <NSObject>
@optional
 ...
 */
+ (nullable NSDictionary<NSString *, id> *)sf_modelCustomPropertyMapper;
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
  @code
        @class SFShadow, SFBorder, SFAttachment;
 
        @interface SFAttributes
        @property NSString *name;
        ...
        @implementation SFAttributes
        + (NSDictionary *)sf_modelContainerPropertyGenericClass {
            return @{@"shadows" : [SFShadow class],
                     @"borders" : SFBorder.class,
                     @"attachments" : @"SFAttachment" };
        }
        @end
  @endcode
 ...
 */
+ (nullable NSDictionary<NSString *, id> *)sf_modelContainerPropertyGenericClass;
...
/**
 ...
 Example:
 @code
        @class SFCircle, SFRectangle, SFLine;
 
        @implementation SFShape

        + (Class)sf_modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [SFCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [SFRectangle class];
 ...
 */
+ (nullable Class)sf_modelCustomClassForDictionary:(NSDictionary *)dictionary;
 ...
 */
+ (nullable NSArray<NSString *> *)sf_modelPropertyBlacklist;
...
/**
 ...
 @return An array of property's name.
 */
+ (nullable NSArray<NSString *> *)sf_modelPropertyWhitelist;
